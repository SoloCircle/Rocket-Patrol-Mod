class Play extends Phaser.Scene{
    ...
    create(){
        ...
        //place bg + other UI elements + initiate anims
        ...
        if(game.settings.mood == 0){
            this.bgMusic = this.sound.add('bgm_02', {volume: 0.4});
        }
        if(game.settings.mood == 1){
        ...
        this.timeText = this.timeInSeconds;
        this.add.text(game.config.width/2, game.config.height/2, this.timeInSeconds);
